...
O sistema de controle foi desenvolvido com um microcontrolador, um
esp8266, programado em python com uso do framework [micropython](https://
micropython.org/). Para o desenvolvimento da placa de circuito impresso (PCB),
foi utilizado o [KiCad](https://www.kicad.org), um programa de Automação de
Design Eletrônico (EDA) open source.
